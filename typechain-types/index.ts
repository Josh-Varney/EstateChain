...
export type { PropertyERC20 } from "./contracts/RentalTokenOwnership.sol/PropertyERC20";
export { PropertyERC20__factory } from "./factories/contracts/RentalTokenOwnership.sol/PropertyERC20__factory";
