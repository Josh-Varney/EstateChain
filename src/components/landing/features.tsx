...
const FeaturesPage: React.FC = () => {
  return (
    <div className="relative min-h-screen bg-gradient-to-r from-gray-800 to-gray-900 text-white overflow-hidden">
      ...
      {/* Hero Section */}
      <section className="py-16 px-6 text-center bg-gradient-to-b from-gray-800 to-gray-900">
        <div className="max-w-4xl mx-auto">
          <p className="text-sm uppercase tracking-wide text-blue-400 font-semibold">
            Key Features
          </p>
          <h1 className="text-4xl md:text-5xl font-extrabold mt-4">
            Transform Real Estate with <span className="text-blue-400">Tokenization</span>
          </h1>
          <p className="mt-4 text-gray-300 text-lg leading-relaxed">
            Empower your investments with cutting-edge tools for fractional ownership, instant liquidity, and global access to real estate.
          </p>
        </div>
      </section>
